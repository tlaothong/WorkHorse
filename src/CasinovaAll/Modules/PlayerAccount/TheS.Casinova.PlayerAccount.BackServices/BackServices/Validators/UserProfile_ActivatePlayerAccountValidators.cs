...
{
    public class UserProfile_ActivatePlayerAccountValidators
        : ValidatorBase<UserProfile, ActivatePlayerAccountCommand>
    {
        private IGetUserProfile _iGetUserProfile;

        public UserProfile_ActivatePlayerAccountValidators(IPlayerAccountDataBackQuery dqr)
        {
            _iGetUserProfile = dqr;
        }

        public override void Validate(UserProfile entity, ActivatePlayerAccountCommand command, ValidationErrorCollection errors)
        {
