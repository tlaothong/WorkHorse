...
{
    public class ExchangeInformation_MoneyToChipsValidators
         : ValidatorBase<ExchangeInformation, MoneyToChipsCommand>
    {
        private IGetPlayerAccountInfo _iGetPlayerAccount;

        public ExchangeInformation_MoneyToChipsValidators(IChipsExchangeModuleDataQuery dqr)
        {
            _iGetPlayerAccount = dqr;
        }
        public override void Validate(ExchangeInformation entity, MoneyToChipsCommand command, ValidationErrorCollection errors)
        {
