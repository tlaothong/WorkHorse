...
{
    public class ExchangeSettingInfo_MoneyToBonusChipsValidators
        : ValidatorBase<ExchangeSettingInformation, MoneyToBonusChipsCommand>
    {
        private IGetExchangeSetting _iGetExchangeSetting;

        public ExchangeSettingInfo_MoneyToBonusChipsValidators(IChipExchangeDataBackQuery dqr)
        {
            _iGetExchangeSetting = dqr;
        }

        public override void Validate(ExchangeSettingInformation entity, MoneyToBonusChipsCommand command, ValidationErrorCollection errors)
        {
