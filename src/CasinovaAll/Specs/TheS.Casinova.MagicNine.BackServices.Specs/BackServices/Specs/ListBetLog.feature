...
@record_mock
Scenario: ได้รับข้อมูล RoundID, UserName, มีข้อมูลที่ต้องการในระบบ 3 รายการ, ระบบดึงประวัติการลงพนันของผู้เล่นทั้งหมดในโต๊ะเกมแล้วส่งกลับ
...
@record_mock
Scenario: ได้รับข้อมูล RoundID, UserName, ไม่มีข้อมูลที่ต้องการในระบบ, ระบบเสมือนทำงานเสร็จ ส่งข้อมูลเปล่ากลับ
	Given The ListBetLogExecutor has been created and initialized
