...
#line 9
testRunner.And("Expect result should be add GameRoundConfig(ConfigName: \'config1\', TableAmount: " +
                    "\'4\', GameDuration: \'30\', Interval: \'5\')");
#line 10
testRunner.When("call CreateGameRoundConfiguration(GameRoundConfig(ConfigName: \'config1\', TableAm" +
