...
namespace TheS.Casinova.Colors.BackServices.Specs
{
    ...
    public class CreateGameRoundConfigurationsSteps
        : ColorsGameStepsBase
    {
        [Given(@"Expect result should be add GameRoundConfigTableName\(TableName: '(.*)', TableAmount: '(.*)', GameDuration: '(.*)', Interval: '(.*)'\)")]
        public void GivenExpectResultShouldBeAddGameRoundConfigurationNameXTableAmountXGameDurationXIntervalX(string name, int tableAmount, int gameDuration, int interval)
        {
            Func<GameRoundConfiguration, CreateGameRoundConfigurationCommand, GameRoundConfiguration> checkdata = (gameRoundConf, cmd) => {
                Assert.AreEqual(name, gameRoundConf.TableName, "Config name");
        ...
        [When(@"call CreateGameRoundConfiguration\(GameRoundConfigTableName\(TableName: '(.*)', TableAmount: '(.*)', GameDuration: '(.*)', Interval: '(.*)'\)\)")]
        ...
        [Then(@"the GameRoundConfigTableName should be saved to the ICreateGameRoundConfigurations\.Create\(GameRoundConfigTableName, CreateGameRoundConfigurationCommand\) with expected data")]
