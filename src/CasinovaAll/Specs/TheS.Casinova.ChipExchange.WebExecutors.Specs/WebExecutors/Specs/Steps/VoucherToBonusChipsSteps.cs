...
namespace TheS.Casinova.ChipExchange.WebExecutors.Specs.Steps
{
    ...
    public class VoucherToBonusChipsSteps
    {
        ...
        public void GivenServerHasVoucherInformationAs(Table table)
        {
            ScenarioContext.Current.Pending();
        }

        [Given(@"Sent UserName'(.*)' VoucherCode '(.*)' the player's voucher information should recieve")]
        ...
        [Given(@"Sent UserName'(.*)' VoucherCode '(.*)' the player's voucher information should not recieve")]
