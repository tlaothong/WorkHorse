...
@record_mock
Scenario: ระบบได้รับข้อมูลครบ ระบบตรวจสอบโบนัส จำนวนโบนัสมีพอสามารถแลกชิพตายได้ ระบบตรวจสอบข้อมูลบัตรเครดิต ข้อมูลบัตรเครดิตถูกต้อง ระบบส่งข้อมูลไป back server ได้  
...
@record_mock
Scenario: ระบบได้รับข้อมูลครบ ระบบตรวจสอบโบนัส จำนวนโบนัสมีพอสามารถแลกชิพตายได้ ระบบตรวจสอบข้อมูลบัตรเครดิต ข้อมูลบัตรเครดิตไม่ถูกต้อง ระบบไม่สามารถส่งข้อมูลไป back server ได้  
	Given The MoneyToBonusChipsExecutor has been created and initialized
	And  Server has player account information for money to bonus chips:
	...
	And  Sent UserName'Boy' the player's bonus point should recieve
	And  Sent AccountType 'Primary' UserName'Boy' the player's account for money to bonus chips should recieve
