...
Scenario: ระบบได้รับข้อมูลครบ ระบบตรวจสอบข้อมูลบัตรเครดิต ข้อมูลบัตรเครดิตถูกต้อง ระบบส่งข้อมูลไป back server ได้  
	...
	And Sent AccountType 'Primary' UserName'Boy' the player's account should recieve
...
@record_mock
Scenario: ระบบไม่ได้รับข้อมูล AccountType ระบบไม่สามารถตรวจสอบข้อมูลบัตรเครดิตได้_MoneyToChip 
	Given The MoneyToChipsExecutor has been created and initialized
	When  Call MoneyToChipsExecutor (AccountType '' Amonut '1000' UserName'Boy') for money to chips
	Then  The system can't sent chips exchange information to back server #MoneyToChip

@record_mock
Scenario: ระบบไม่ได้รับข้อมูล UserName ระบบไม่สามารถตรวจสอบข้อมูลบัตรเครดิตได้_MoneyToChip 
	Given The MoneyToChipsExecutor has been created and initialized
