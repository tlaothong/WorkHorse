                ...
                <td style="float: left; margin-top: 5px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="birthday" type="text" style="width: 170px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" />Show only friend action
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" />Show only self action
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" />My friend only
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="radio" />All users read only
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" />All users can read & write
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" />My friend read only
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" />My friend can read & write
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="radio" />Only me can write
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <tr>
            ...
            <td valign="top">
                <div style="float: left; padding-left: 50px; margin-top: 0px;">
                    ...
                    <div>
                        <br />
                        <label id="editProfile" style="border: 1px solid Gray; background-color: #E7E8E9;
            ...
            <td valign="top">
                <div style="float: left; padding-left: 35px; margin-top: 0px;">
