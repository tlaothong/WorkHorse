...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: #505151; padding-top: 10px; padding-bottom: 20px; margin-top: 25px;
        ...
        <div style="background-color: White; border: 1px solid gray; margin-left: 50px; width: 150px;
            text-align: center; color: #5FB546;">
            <label>
                KnowledgeCenter</label></div>
        ...
        <div style="width: 150px; margin-right: 20px; margin-left: 430px;t">
            <div>
            ...
            <div style="margin-top: 10px;">
                <div style="border: 2px solid #727373; width: 150px; text-align: center; color: #5FB546;
                    margin-bottom: -2px;">
