    ...
    <div style="width: 159; height: 400px;">
        ...
        <div style="margin-bottom: 5px; padding-bottom: 5px; width: 159px; margin-left: 5px;
            ...
            <div style="width: 30px; float: right;">
                <a href="#" class="ReportCommentGame_Click" style="color: gray; text-decoration: none;">report</a>
            </div>
        </div>
        <div style="margin-bottom: 5px; padding-bottom: 5px; width: 159px; margin-left: 5px;
            ...
            <div style="width: 30px; float: right;">
                <a href="#" class="ReportCommentGame_Click" style="float: right; color: gray; text-decoration: none;">report</a>
            </div>
        </div>
        <br />
