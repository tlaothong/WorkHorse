...
<script type="text/javascript">
    Sys.require(Sys.components.dropDown, function () {
        $("#dropSearchVideo").dropDown({
            dropDownControl: Sys.get("#dropMenuVideo")
        });
    });
</script>
<div style="padding-left: 660px; float: left;">
     ...
     <a href="#"><label>Advance Search</label></a>
        <span id="dropCategory_dropWrapper" style="cursor: default;"><span id="dropSearchVideo"
            style="display: block; width: 150px; height: 18px; background-color: transparent; font-size:small">ค้นหา</span>
        </span>
        <div id="dropMenuVideo" class="ContextMenuPanel" style="visibility: hidden; display: none;
            width: 148px;">
